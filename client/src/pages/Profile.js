...
const Profile = () => {
  ...
  if (!user?.username) {
    return (
      <h4 className="profile-warning-message text-center fw-bolder">
        You need to be logged in to access your account settings. Use the
  ...
  return (
    <div style={containerStyle}>
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
        ...
        <div className="row">
          <button type="submit" className="btn ml-3 p-2 mb-3 col-11 fw-bolder">
            Save Changes
          </button>
        </div>
        {showSuccessMessage && (
