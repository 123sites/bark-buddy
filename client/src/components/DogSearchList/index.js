...
function DogSearchList() {
    ...
    // need to create a query for dogs, add it to tyepdefs, mutations, queries, resolvers
    // then import here and add line below
    //const { loading, data } = useQuery(QUERY_DOGS);

    /*return (
        <div className="my-2">
        <h2>Pups Available for Adoption</h2>
...
import Auth from '../utils/auth';
import { searchPooch } from '../utils/GlobalState';
